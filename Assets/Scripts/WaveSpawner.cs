...
public class WaveSpawner : MonoBehaviour
{
    ...
    void FixedUpdate(){
        ...
        if ((player1 || player2) && !enemySpawning && LevelManager.spawnEnemies && !LevelManager.isPaused && LevelManager.isFunctional){
            // Gets all currently alive enemies
            enemyCount = FindObjectsByType(typeof(Enemy), FindObjectsSortMode.None).Length;
            ...
            if (enemyCount == 0 && enemiesToSpawn == 0 && !startingWave){
                ...
                CoopPlayer p1 = player1.GetComponent<CoopPlayer>();
    ...
    IEnumerator SpawnEnemy(){
        ...
        Instantiate(alien, spawnPoints[Random.Range(0, spawnPoints.Count)].transform.position, alien.transform.rotation);
